    ...
    <nav className="navbar">
      ...
      <ul className="nav-links">
        {location.pathname === "/talent-scout" ? (
          ...
          <>
            {location.pathname !== "/" && <li><span onClick={() => navigate("/")}>Back to Main</span></li>}
            {location.pathname !== "/talent" && <li><span onClick={() => navigate("/talent")}>Talent</span></li>}
            {location.pathname !== "/talent-scout" && <li><span onClick={() => navigate("/talent-scout")}>Talent Scout</span></li>}
